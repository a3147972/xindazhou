...
<link rel="stylesheet" href="PATH_CSS/bootstrap-responsive.min.css" />
<link rel="stylesheet" href="PATH_CSS/fullcalendar.css" />
<link rel="stylesheet" href="PATH_CSS/unicorn.main.css" />
<link rel="stylesheet" href="PATH_CSS/unicorn.grey.css" class="skin-color" />
<body>
    <div id="header">
    <h1><a href="<?php echo U('/index');?>">管理系统</a></h1>
</div>
...
<div id="user-nav" class="navbar navbar-inverse">
    ...
    <div id="sidebar">
    <a href="<?php echo U('/index');?>" class="visible-phone"><i class="icon icon-home"></i> 后台首页</a>
    <ul>
        <li class="active"><a href="<?php echo U('/index');?>"><i class="icon icon-home"></i> <span>后台首页</span></a></li>
        <li class="submenu">
            <a href="<?php echo U('News/index');?>"><i class="icon icon-th-list"></i> <span>新闻管理</span></a>
        </li>
        <li><a href="<?php echo U('ProductClass/index');?>"><i class="icon icon-tint"></i> <span>车型管理</span></a></li>
        <li><a href="<?php echo U('Menu/index');?>"><i class="icon icon-pencil"></i> <span>自定义菜单管理</span></a></li>
        <li><a href="<?php echo U('City/index');?>"><i class="icon icon-th"></i> <span>城市管理</span></a></li>
        <li><a href="<?php echo U('Address/index');?>"><i class="icon icon-th"></i> <span>地址管理</span></a></li>
        <li><a href="<?php echo U('System/index');?>"><i class="icon icon-th-list"></i> <span>系统设置</span></a></li>
        <li class="submenu">
            <ul>
        ...
        <li>
            <a href="<?php echo U('/');?>"><i class="icon icon-signal"></i> <span>Charts &amp; graphs</span></a>
        </li>
        <li>
            <a href="<?php echo U('/');?>"><i class="icon icon-inbox"></i> <span>Widgets</span></a>
        </li>
    </ul>
...
<script src="PATH_JS/excanvas.min.js"></script>
<script src="PATH_JS/jquery.min.js"></script>
<script src="PATH_JS/jquery.ui.custom.js"></script>
<script src="PATH_JS/bootstrap.min.js"></script>
<script src="PATH_JS/jquery.flot.min.js"></script>
<script src="PATH_JS/jquery.flot.resize.min.js"></script>
<script src="PATH_JS/jquery.peity.min.js"></script>
<script src="PATH_JS/fullcalendar.min.js"></script>
<script src="PATH_JS/unicorn.js"></script>
<script src="PATH_JS/unicorn.dashboard.js"></script>
</body>
</html>